...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs.send(
      ...
      {from_name: form.name,
        ...
        to_email: "workspace9801@gmail.com",
  ...
  return (
    <div className="xl:mt-12 xl:flex-row flex-reverse flex gap-10 overflow-hidden">
      <motion.div
        ...
        >
          ...
          <button
            ...
            className="bg-tertiary py-3 px-8 outline-none
              w-fit text-white font-bold shadow-md shadow-primay rounded-xl"
          >
